...
subtitle: "<span style='font-size:1.75em;'>How to Create Engaging and Complex Visualizations in R</span>"
...
##  {background-image="img/portfolio/marco_germany_heating_up.png" background-position="center" background-size="36%"}


##  {background-image="img/intro/team.png" background-position="center" background-size="75%"}


##  {background-image="img/portfolio/hassan_geom_tile_34_0.png" background-position="center" background-size="75%"}
...
![Illustration by Allison Horst](img/intro/ah_ggplot2_exploratory.png){fig-align="center" fig-alt="Allison Horsts monster illustration of explorative plotting with ggplot2."}
...
![Illustration by Allison Horst](img/intro/ah_ggplot2_masterpiece.png){fig-align="center" fig-alt="Allison Horsts monster illustration of building  data masterpiece ith ggplot2 featuring a little Picasso monster :)"}
...
ggplot(bikes, aes(temp_feel, count)) +
  ...
  scale_color_manual(
    values = c("#00CB79","#F7B01B","#a78f5f","#69b0d4"), name = "Season:",
...
ggplot(bikes, aes(temp_feel, count)) +
  ...
  scale_color_manual(
    values = c("#00CB79","#F7B01B","#a78f5f","#69b0d4"), name = NULL,
    guide = guide_legend(override.aes = list(size = 5))
  ) +
  labs(
    x = "Feels-Like Temperature", y = NULL, 
