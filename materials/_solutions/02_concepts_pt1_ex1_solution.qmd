...
* Explore the TfL bike share data visually:<br>**create a timeseries of reported bike shares on weekend days**
    ...
    - <span style='color:#5DB699;'>Bonus: use shape to encode Saturday vs Sunday instead.</span>
...
## Bonus: Use Shape to Encody Sat vs Sun
...
#| include: false
ggsave(here::here("exercises", "plots", "02_concepts_pt1_ex1_bonus.png"), 
       width = 9, height = 5, dpi = 350, bg = "white")
```
