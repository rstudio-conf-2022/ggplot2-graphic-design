...
-   Open the script [`exercises/05_labels_ex1.qmd`](../materials/exercises/05_labels_ex1.qmd) (or the `.rmd`).
...
::: question
-   Open the script [`exercises/05_labels_ex2.qmd`](../materials/exercises/05_labels_ex2.qmd) (or the `.rmd`).
